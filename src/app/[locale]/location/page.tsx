              ...
              <Reveal delay={0.08}>
                ...
                <div className="prose-ink measure-wide">
                  ...
                  <p>
                    ...
                    receive a parking card, subject to availability. The
                    Residence of the Old Port has private parking of its own.
                  </p>
                </div>
      ...
      <Section ground="shade" size="md">
        <Container>
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {/* The same mobile as above, reached the way most guests abroad
                would rather reach it. */}
            <div>
