...
export const nl: Messages = {
  ...
  home: {
    ...
    familyProofVillasBody: "Thalasses Villas, Villa Thetis, Villa Ikaros, Casa Vitae en een dozijn andere aan deze kust — dezelfde familie, dezelfde maatstaven.",
    familyProofOfficesTerm: "Drie kantoren",
    familyProofOfficesBody: "Rethymno, Heraklion en Athene.",
