...
const KEYS = {
  ...
  familyProofVillasBody: {
    en: "Thalasses Villas, Villa Thetis, Villa Mavi and a dozen more along this coast — the same family, the same standards.",
    el: "Thalasses Villas, Villa Thetis, Villa Mavi και άλλες δώδεκα σε αυτή την ακτή — η ίδια οικογένεια, οι ίδιες προδιαγραφές.",
    de: "Thalasses Villas, Villa Thetis, Villa Mavi und ein Dutzend weitere an dieser Küste — dieselbe Familie, dieselben Maßstäbe.",
    fr: "Thalasses Villas, Villa Thetis, Villa Mavi et une douzaine d'autres sur cette côte — la même famille, les mêmes exigences.",
    nl: "Thalasses Villas, Villa Thetis, Villa Mavi en een dozijn andere aan deze kust — dezelfde familie, dezelfde maatstaven.",
  },
